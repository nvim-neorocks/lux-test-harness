local git_ref = '6921a831d79d515d64400a9e022cf30e68a2a3dd'
local modrev = '0.0.42'
local specrev = '1'
...
dependencies = { 'lua >= 5.1', 'tree-sitter-ocaml == 0.0.41' } 
...
source = {
  ...
  dir = 'tree-sitter-ocaml-' .. '6921a831d79d515d64400a9e022cf30e68a2a3dd',
}
